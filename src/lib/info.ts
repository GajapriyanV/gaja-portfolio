...
export const experiences = [
    ...
    },
    {
        ...
        desc: "Worked with hundreds of clients that requested aid in navigating both front-end and back-end aspects of projects while maintaining strong client-centricity. My proficiency in React allowed me to craft visually appealing and highly interactive front-end interfaces that aligned with clients' specific requirements and brand identities. Meanwhile, on the back-end, I skillfully managed SQL and NoSQL databases, ensuring data integrity and responsiveness for seamless user experiences.",
    },  
